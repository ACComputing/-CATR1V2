...
# Fixed for Python 3.14 & macOS / Cross-Platform
# Fixes: NameError tk, TclError padx/pady tuple, NSException tkinter crash
# =============================================================================
...
class CollapsibleThought(tk.Frame):
    ...
    def __init__(self, parent, colors):
        ...
        # FIX: never pass tuples to padx/pady in widget constructors
...
class CatSeekApp:
    ...
    def setup_ui(self):
        ...
        tk.Label(
            self.sidebar, text="Reasoning Engine",
            font=("Arial", 10),
        ...
        # Input Area — FIX: no tuple in padx/pady
